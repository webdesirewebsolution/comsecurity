...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* <nav className="navbar container">
          ...
          <button data-collapse-toggle="navbar-dropdown" type="button" data-te-target="#navbar-dropdown" className="inline-flex items-center
           ...
           focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbarSupportedContentY">
