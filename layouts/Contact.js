        ...
        <section class="mb-32"> 
          <div class="flex flex-wrap">
            <div class="mb-10 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
              <h2 class="mb-6 text-3xl font-bold">Feel free to contact us for any questions and doubts​</h2>
              <p class="mb-6 text-neutral-500 dark:text-neutral-300">
              If you are looking for a body guard , House kepper,
Security Guard, Gunman so connect us.
              </p>
              {/* <p class="mb-2 text-neutral-500 dark:text-neutral-300">
                Email:- care@comsecurity.in
              </p> */}
              <p class="mb-2 text-neutral-500 dark:text-neutral-300">
              +91-9971565508
              </p>
                ...
                <div class="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
                  ...
                  <div
                    ...
                    <div class="align-start flex">
                      ...
                      <div class="ml-6 grow">
                        <p class="mb-2 font-bold dark:text-white">Branch Office Haryana</p>
                        <p class="text-neutral-500 dark:text-neutral-200">
